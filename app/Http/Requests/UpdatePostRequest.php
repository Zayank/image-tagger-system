...
class UpdatePostRequest extends FormRequest
{
    ...
    protected function prepareForValidation()
    {
        ...
        $post =  Post::where('id',$this->id)
                     ...
                     ->first();      
        if( null === $post || !isset($post->image_path))  {

                    throw new HttpResponseException(response()->json(['error' => true, 'message' => __('posts.invalid_request')], 400)); 
